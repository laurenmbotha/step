...
public final class FindMeetingQueryTest {
  ...
  private static final int start = TimeRange.getTimeInMinutes(0, 0);
  private static final int end = TimeRange.getTimeInMinutes(23, 59);
...
@Test
  public void everyOptionalAttendeeIsConsidered() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartDuration(start, end),
